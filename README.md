...
Primary Data Bucket: Encrypted using a customer-managed KMS key (AWS-0132 compliant).

Logging Bucket: Encrypted using AES256, the required standard for S3 server access logging destinations.
...
Infrastructure Compliance: The infrastructure has been scanned and verified against security standards using Trivy, ensuring zero misconfigurations.
